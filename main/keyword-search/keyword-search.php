...
<html>
    <head>
        ...
        <!-- キーワード検索結果用SS  -->
        <link rel="stylesheet" type="text/css" href="./keyword-search-style.css">
    </head>
    ...
    <body>
        ...
        <div class="header">
            ...
            <!-- 検索フォーム  -->
            <form class="search-form" name="search_threads" method="POST" action="./keyword-search.php">
        ...
        <div class="container">
            ...
            <div class="main">
                <div class="content">
                    <!-- 検索結果  -->
                    <div id="search_threads_result">
                        <h1 class="result-sentence" id=result_sentence></h1>
                        <dl id="search_threads_list"></dl>
                    </div>
                </div>
            </div>
            ...
            <script type="text/javascript">
                ...
                $.ajax({
                    type: "POST",
                    url: "./KeywordSearchBK.php",
                    data: {
                        'search_word': search_word,
                    }
                })
                .done(function(data){
                    $("#result_sentence").text("キーワード:"+data[0].word+" に関するスレッド一覧");
                    if (data[1] != null)
                    {
                        for (let i = 1; i < data.length; i++)
                        {
                            ...
                            $("#search_threads_list").append(h);
                        }
                    } else {
                        $("#search_threads_list").append("<h3 class='not-thread'>スレッドは存在しません。</h3>");
                    }
                })
            </script>
